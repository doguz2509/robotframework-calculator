...
from robot_math.types.packet_type import Packet as PacketSize, Packet
...
class TestBitrate(TestCase):
    ...
    def test_sum_positive(self):
        ...
        for _sum, (_b1, _b2) in summ_p.items():
            try:
                s, b1, b2 = Packet(_sum), Packet(_b1), Packet(_b2)
                _b = [b1, b2]
                r_s = sum(_b)
